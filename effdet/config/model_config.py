...
efficientdet_model_param_dict = dict(
    ...
    # Add to config/model_config.py under your mobilenetv4 entries:
    # Add to config/model_config.py under your mobilenetv4 entries:
    mobilenetv4_conv_small=dict(
        ...
        redundant_bias=False,
        head_bn_level_first=True,
        backbone_args={},  # no public ImageNet weights
        url="",
    ),
    mobilenetv4_conv_small_035=dict(
        name="mobilenetv4_conv_small_035",
        backbone_name="mobilenetv4_conv_small_035",
        image_size=(320, 320),
        aspect_ratios=[1.0, 2.0, 0.5],
        fpn_channels=48,
        fpn_cell_repeats=3,
    ...
    mobilenetv4_conv_small_050=dict(
        name="mobilenetv4_conv_small_050",
        ...
        redundant_bias=False,
        head_bn_level_first=True,
        backbone_args={},  # has timm/HF ImageNet weights
        url="",
    ),
    mobilenetv4_conv_aa_medium=dict(
        name="mobilenetv4_conv_aa_medium",
        backbone_name="mobilenetv4_conv_aa_medium",
        image_size=(384, 384),
        aspect_ratios=[1.0, 2.0, 0.5],
        fpn_channels=56,
        fpn_cell_repeats=3,
    ...
    mobilenetv4_conv_blur_medium=dict(
        name="mobilenetv4_conv_blur_medium",
        backbone_name="mobilenetv4_conv_blur_medium",
        image_size=(384, 384),
        aspect_ratios=[1.0, 2.0, 0.5],
        fpn_channels=56,
        fpn_cell_repeats=3,
    ...
    mobilenetv4_conv_aa_large=dict(
        name="mobilenetv4_conv_aa_large",
        ...
        redundant_bias=False,
        head_bn_level_first=True,
        backbone_args={},  # no official HF weights for the AA variant
        url="",
    ),
    mobilenetv4_conv_large=dict(
    ...
    mobilenetv4_hybrid_medium=dict(
    ...
    mobilenetv4_hybrid_medium_075=dict(
        name="mobilenetv4_hybrid_medium_075",
        backbone_name="mobilenetv4_hybrid_medium_075",
        image_size=(384, 384),
        aspect_ratios=[1.0, 2.0, 0.5],
        fpn_channels=56,
        fpn_cell_repeats=3,
        ...
        redundant_bias=False,
        head_bn_level_first=True,
        backbone_args={},  # no official HF weights for this variant
        url="",
    ),
    mobilenetv4_hybrid_large=dict(
        name="mobilenetv4_hybrid_large",
        backbone_name="mobilenetv4_hybrid_large",
        image_size=(512, 512),
        aspect_ratios=[1.0, 2.0, 0.5],
        fpn_channels=64,
        fpn_cell_repeats=3,
    ...
    mobilenetv4_hybrid_large_075=dict(
        name="mobilenetv4_hybrid_large_075",
        backbone_name="mobilenetv4_hybrid_large_075",
        image_size=(512, 512),
        aspect_ratios=[1.0, 2.0, 0.5],
        fpn_channels=64,
        fpn_cell_repeats=3,
